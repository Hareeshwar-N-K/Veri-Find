...
const MatchDetail = () => {
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      ...
      console.log("Submitting verification with matchId:", match.id);

      // Use verifyMatch from matching service
      await verifyMatch(match.id, quizAnswers, {
        correctCount,
      ...
      toast.error(
        `Failed to submit verification: ${error.message || "Unknown error"}`
      );
    } finally {
      setVerifying(false);
    }
