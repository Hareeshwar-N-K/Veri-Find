...
import { findMatchesForFoundItem, createMatch } from "../services/matching";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        if (matches.length > 0) {
          // Create match with the best match
          ...
          toast.success(
            <div className="flex flex-col">
              ...
              <span className="text-sm">
                We found {matches.length} potential match(es) for this item!
              </span>
            </div>,
            { duration: 5000 }
          );
      ...
      toast.success(
        <div className="flex flex-col">
          ...
          <span className="text-sm">
            Thank you for your honesty. We'll help reunite it with its owner.
          </span>
        </div>,
        { duration: 5000 }
      );
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto">
              Your honesty can make someone's day! Help reunite lost items with
              their owners.
            </p>
          </div>
                            ...
                            <div className="space-y-3">
                              <div className="flex items-start space-x-3">
                                ...
                                <p className="text-cyan-200">
                                  <strong>Your report is private</strong> - Only
                                  visible to potential owners after AI
                                  verification
                                </p>
                              </div>
                              <div className="flex items-start space-x-3">
                                ...
                                <p className="text-cyan-200">
                                  <strong>Secure matching</strong> - Owners must
                              ...
                              <div className="flex items-start space-x-3">
                                ...
                                <p className="text-cyan-200">
                                  <strong>
                                    Your contact info is protected
                                  </strong>{" "}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold text-white">
                                {formData.storageLocation || "Not specified"}
                              </span>
                            </div>
                          </div>
                        </div>
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 max-w-md text-center animate-pop border border-white/20">
                ...
                <p className="text-slate-300 mb-6">
                  Your found item report is being processed...
                </p>
