        ...
        <div className="max-w-md mx-auto">
          ...
          <div className={`text-center mb-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="relative inline-block mb-8">
              <div className="w-24 h-24 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg animate-float mx-auto">
            ...
            <p className="text-lg text-slate-300">
              Securely access your Lost & Found portal
            </p>
          </div>
          ...
          <div className={`bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{animationDelay: '0.2s'}}>
            ...
            <div className="relative group">
                  ...
                  {isLoading ? (
                    ...
                    <>
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs text-slate-400">Secure, fast, and simple</div>
                      </div>
                    </>
                  )}
                </div>
              ...
              <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-300 pointer-events-none"></div>
            </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm text-slate-400">New to VeriFind?</span>
              </div>
            </div>
          ...
          {isLoading && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 max-w-md text-center animate-pop border border-white/20">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Signing You In</h3>
                <p className="text-slate-300 mb-6">Please wait while we secure your session...</p>
