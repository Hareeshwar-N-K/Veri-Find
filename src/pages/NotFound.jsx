      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto w-full">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-8xl font-bold mb-6 leading-tight">
                ...
                >
                  ...
                  <span className="relative inline-block">
                    ...
                    <span
                      className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 blur-2xl opacity-30 animate-pulse-slow"
              ...
              <p className="text-xl lg:text-2xl text-slate-300 max-w-3xl mx-auto mb-10 leading-relaxed animate-typewriter">
                This page seems to have wandered off, just like your lost items
                might have. But don't worry - we're experts at finding things!
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold mb-6 animate-slide-up">
                Quick{" "}
                <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent animate-gradient">
                  Navigation
                </span>
              </h2>
              <p
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                >
                  <div
                    className={`relative z-10 w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-3xl transform group-hover:rotate-12 group-hover:scale-110 transition-transform duration-300`}
                  >
                    {item.icon}
                    <div
                      className={`absolute -inset-2 bg-cyan-500/20 blur-lg rounded-2xl animate-ping opacity-0 group-hover:opacity-100`}
                    ></div>
                  </div>
        ...
        <section className="relative py-20 px-6 lg:px-20">
          <div className="max-w-4xl mx-auto text-center">
            <div
              className={`relative p-12 rounded-3xl overflow-hidden transition-all duration-1000 animate-slide-up ${
                isVisible
                  ? "opacity-100 translate-y-0"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p
                  className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto animate-typewriter"
                  style={{ animationDelay: "0.5s" }}
                >
                  Whether it's a lost item or just the right page, we're here to
                  help
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-3">
                      Need Help?
                      <span className="text-xl group-hover:translate-x-2 group-hover:rotate-12 transition-all duration-300">
                        🚀
                      </span>
                    </span>
                  </Link>
