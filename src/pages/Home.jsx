...
const loadGoogleMap = async () => {
  ...
  const campusBuildings = [
    ...
    {
      name: "Hostel Blocks",
      position: { lat: 11.0290, lng: 77.0280 },
      icon: "🏠",
    ...
    },
    {
      ...
      position: { lat: 11.0286, lng: 77.0270 },
      icon: "💻",
      description: "IT Department & Labs"
    },
    {
      name: "Parking Area",
      position: { lat: 11.0280, lng: 77.0273 },
      icon: "🚗",
      ...
      const infoWindow = new window.google.maps.InfoWindow({
        content: `
          <div class="p-3 bg-gray-900 text-white rounded-lg shadow-lg max-w-xs">
            ...
            <div class="text-sm text-gray-300 mt-1">${building.description}</div>
            <div class="text-xs text-gray-400 mt-2">
              📍 ${building.position.lat.toFixed(5)}, ${building.position.lng.toFixed(5)}
            </div>
          </div>
        `
      });
  ...
  const processHeatmapData = (lostItems) => {
    ...
    const mockLocations = [
      ...
      { lat: 11.0290, lng: 77.0280, count: 6 },  // Hostel
      { lat: 11.0278, lng: 77.0268, count: 4 },  // Sports
      { lat: 11.0286, lng: 77.0270, count: 9 },  // Computer Center
      { lat: 11.0280, lng: 77.0273, count: 11 }, // Parking
    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-[#0A0F29] via-[#111827] to-[#1E1B4B] text-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl lg:text-2xl text-slate-300 max-w-3xl mx-auto mb-10 leading-relaxed">
              Official Lost & Found System for Coimbatore Institute of Technology
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
              CIT Campus <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Live Heatmap</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-8">
              Real-time visualization of lost items across Coimbatore Institute of Technology
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-300">Very High Activity</span>
              </div>
            </div>
          </div>
          ...
          <div className={`relative transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            ...
            <div className="relative h-[500px] lg:h-[600px] rounded-3xl border-2 border-cyan-500/30 overflow-hidden shadow-2xl">
              ...
              {mapLoading && (
                <div className="absolute inset-0 bg-gradient-to-br from-slate-900/90 to-slate-800/90 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-slate-300 text-xl font-semibold mb-2">Loading Campus Map...</p>
                    <p className="text-slate-400">Coimbatore Institute of Technology</p>
                    <p className="text-sm text-slate-500 mt-2">11.0283° N, 77.0273° E</p>
                  </div>
                </div>
              )}
              ...
              {mapError && (
                <div className="absolute inset-0 bg-gradient-to-br from-red-900/90 to-purple-900/90 flex items-center justify-center p-6">
                  <div className="text-center max-w-md">
                    ...
                    <h3 className="text-xl font-bold text-white mb-3">Map Loading Error</h3>
                    ...
                    <div className="bg-black/50 p-4 rounded-lg text-sm text-left">
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-gray-400">
                        <li>Add <code>VITE_GOOGLE_MAPS_API_KEY</code> to .env file</li>
                        <li>Enable Maps JavaScript API in Google Cloud</li>
                        <li>Add <code>http://localhost:*</code> to API restrictions</li>
                      </ol>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm rounded-xl p-4 border border-white/10 max-w-xs">
                <div className="text-sm font-semibold text-cyan-300 mb-1">🗺️ CIT Campus Map</div>
                <div className="text-xs text-slate-300">Interactive heatmap of lost items</div>
                <div className="text-xs text-slate-400 mt-2">Click buildings for details</div>
              </div>
                ...
                {loadingStats ? (
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-bold text-cyan-300">{campusStats.totalLostItems}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-300">Today:</span>
                      <span className="font-bold text-yellow-300">{campusStats.todayLostItems}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-300">This Week:</span>
                      <span className="font-bold text-orange-300">{campusStats.thisWeekLostItems}</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
              <div className="p-6 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-3xl font-bold text-cyan-300">{campusStats.totalLostItems}</div>
                  <div className="w-12 h-12 rounded-full bg-cyan-500/20 flex items-center justify-center">
                    <span className="text-2xl">📦</span>
                  </div>
                </div>
                <div className="text-slate-300 font-medium">Total Items Lost</div>
                <div className="text-sm text-slate-400 mt-1">Across CIT Campus</div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-3xl font-bold text-purple-300">{campusStats.todayLostItems}</div>
                  <div className="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center">
                    <span className="text-2xl">📅</span>
                  </div>
                </div>
                <div className="text-slate-300 font-medium">Lost Today</div>
                <div className="text-sm text-slate-400 mt-1">Items reported today</div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-green-500/10 to-teal-500/10 border border-green-500/20 hover:border-green-500/40 transition-all duration-300">
                ...
                <div className="text-sm text-slate-400 mt-1">Sports Complex</div>
              </div>
            </div>
            ...
            {campusStats.hotspots.length > 0 && (
              <div className="mt-12 p-8 rounded-2xl bg-slate-900/40 backdrop-blur-sm border border-white/10">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                  <div>
                    <h3 className="text-2xl font-bold">🏆 Top Loss Hotspots at CIT</h3>
                    <p className="text-slate-400 mt-2">Most frequent locations where items are lost</p>
                  </div>
                  <button 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                  {campusStats.hotspots.map((hotspot, index) => {
                    const building = campusBuildings.find(b => b.name === hotspot.name);
                    return (
                      <div 
                        key={index} 
                      ...
                      >
                        <div className="flex items-center justify-between mb-4">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold ${
                            index === 0 ? 'bg-gradient-to-br from-red-500 to-pink-600' :
      ...
      <section className="relative z-10 py-20 px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
              Why <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">VeriFind CIT</span> Works
            </h2>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              Official platform for Coimbatore Institute of Technology's lost & found system
            </p>
          </div>
          ...
          <div className={`relative p-12 rounded-3xl overflow-hidden transition-all duration-1000 ${
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
                Join thousands of CIT students who trust our platform for item recovery
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Coimbatore Institute of Technology</p>
              </div>
            </div>
            
            <div className="text-center md:text-right">
              <p className="text-slate-400 mb-2">Official Campus Lost & Found System</p>
