...
/**
 * Log an admin action to audit_logs (transparent decision trail)
 * Called whenever admin deletes an item or overrides a match status.
 */
export async function logAdminAction(action, targetId, targetCollection, reason) {
  const currentUser = auth.currentUser;
